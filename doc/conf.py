...
# latex_documents = [
    # (master_doc, 'EVAICS.tex', 'EVA ICS Documentation', 'AlterTech', 'manual'),
# ]
...
# man_pages = [(master_doc, 'evaics', 'EVA ICS Documentation', [author], 1)]
...
# texinfo_documents = [
    # (master_doc, 'EVAICS', 'EVA ICS Documentation', author, 'EVAICS',
